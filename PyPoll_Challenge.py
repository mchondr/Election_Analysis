...
largest_county = ""
largest_county_turnout_abs = 0
largest_county_turnout_percent = 0
...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_options:
        ...
        if (votes > largest_county_turnout_abs) and (vote_percentage > largest_county_turnout_percent):
            largest_county_turnout_abs = votes
            largest_county = county
            argest_county_turnout_percent = vote_percentage
