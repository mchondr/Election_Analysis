...
for candidate_name in candidate_votes:
    ...
    print(f"{candidate_name}: received {vote_percentage:{3},.{2}}% of the vote.")
...
#print(f'{winning_candidate} is the winner. They received {winning_count} votes and {winning_percentage:{3},.{2}}% of the vote.')
